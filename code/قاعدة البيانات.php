...
--
-- ظ…ط¶ظٹظپ: 127.0.0.1
-- ظˆظ‚طھ ط§ظ„ط¬ظٹظ„: 12 ط³ط¨طھظ…ط¨ط± 2025 ط§ظ„ط³ط§ط¹ط© 23:36
...
INSERT INTO `police_alerts` (`alert_id`, `alert_title`, `alert_message`, `alert_date`, `target_department`, `is_sent`) VALUES
(1, 'Bznz', 'Nanansn', '2025-09-03 23:58:33', 'All', 0);
...
(27, '2025-09-02 16:52:14', 'ظ‚طھظ„ ط´ط®طµ ط¨ط§ظ„ط³ظƒظٹظ† ط­طھظ‰ ط§ظ„ظ…ظˆطھ', 1, 17, 'opened', 1, 4),
(28, '2025-09-02 16:52:14', 'ط¶ط±ط¨ ط´ط®طµ ط¨ط§ظ„ط¹طµظ‰ ط­طھظ‰ ظƒط³ط± ط§ظ„ط¹ط¶ظ…', 2, 23, 'opened', 1, 8),
(29, '2025-09-02 16:54:30', 'ط³ط±ظ‚ط© ظ…ظ†ط²ظ„ ط§ظ„ط³ط§ط¹ظ‡ ط§ظ„ط¹ط§ط´ط±ط© ', 1, 16, 'opened', 1, 4),
(30, '2025-09-02 16:58:12', 'ط§ط¨طھط²ط§ط² ظ…ط§ظ„ظٹ ', 5, 33, 'opened', 1, 8),
(31, '2025-09-02 16:58:12', 'ط³ط±ظ‚ط© ط³ظٹط§ط±ط§طھ', 1, 18, 'closed', 2, 13),
(32, '2025-09-02 17:03:59', 'ط§ط®طھط·ط§ظپ ط¹ظ…ط± ط³ط¹ظٹط¯ ', 4, 30, 'opened', 2, 13),
(33, '2025-09-02 17:03:59', 'طھظ‡ط¯ظٹط¯ ط´ط®طµ', 5, 31, 'prosse', 2, 13),
...
CREATE TABLE `suspects` (
  ...
  `status` enum('Wanted','Arrested','Cleared') NOT NULL DEFAULT 'Wanted',
  `age` int(4) NOT NULL,
  `created_at` datetime NOT NULL DEFAULT current_timestamp(),
...
(1, 'ظ…ط­ظ…ط¯ ط¹ظ„ظٹ ظ‚ط§ط¦ط¯', '777222483', 'طھط¹ط² ظ…ط¯ظٹط±ط© ط§ظ„ظ‚ط§ظ‡ط±ط©', 'Wanted', 0, '0000-00-00 00:00:00', '18383838193838', 1, 1, 'male'),
(31, 'ط§ط­ظ…ط¯ ظ‚ط§ط¦ط¯ ط¹ط¨ط¯ط§ظ„ظ„ظ‡ ط§ط­ظ…ط¯ ', '7784549282', '82828', 'Wanted', 94, '2025-09-03 19:13:54', '828288283', 1, 6, 'female'),
(32, 'ط§ط³ط¹ط¯ ط­ظ…ظٹط¯ ط³ظٹظپ ط§ظ„ط³ط¹ط¯ط§ظˆظٹ', '7784549282', '82828', 'Wanted', 94, '2025-09-03 19:14:00', '828288283', 1, 6, 'female');
